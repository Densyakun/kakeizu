// Copied and modified from browser-gimei
'use strict';
...
var gimei = (function () {
  ...
  var address = {
    ...
    setAddresses: function (addresses: any) {
    ...
    createPrefecture: function (i: number) {
      return this.prefectures[this.prefectureIndex][i];
    },

    createCity: function (i: number) {
      return this.cities[this.cityIndex][i];
    },

    createTown: function (i: number) {
      return this.towns[this.townIndex][i];
    },

    createFullAddress: function (i: number) {
      return (
    ...
    createAddress: function (i: number) {
      var str = '';
